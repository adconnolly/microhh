...
#ifndef DIFF_DNN_STATS_H
#define DIFF_DNN_STATS_H
...
class Diff_dnn_stats : public Diff<TF>
{
    public:
        Diff_dnn_stats(Master&, Grid<TF>&, Fields<TF>&, Boundary<TF>&, Input&);
        ~Diff_dnn_stats();
    ...
    private:
        ...
        const Diffusion_type swdiff = Diffusion_type::Diff_dnn_stats;
