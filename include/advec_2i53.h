...
class Advec_2i53 : public Advec<TF>
{
    public:
        Advec_2i53(Master&, Grid<TF>&, Fields<TF>&, Input&); ///< Constructor of the advection class.
        ~Advec_2i53(); ///< Destructor of the advection class.
