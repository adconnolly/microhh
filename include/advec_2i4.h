...
/**
 * Derived class for 2nd order advection scheme with 3rd order interpolations.
 */
template<typename TF>
class Advec_2i4 : public Advec<TF>
{
    public:
        Advec_2i4(Master&, Grid<TF>&, Fields<TF>&, Input&); ///< Constructor of the advection class.
        virtual ~Advec_2i4(); ///< Destructor of the advection class.
        ...
        void get_advec_flux(
                Field3d<TF>&, const Field3d<TF>&,
                const std::vector<TF>&, const std::vector<TF>&);
