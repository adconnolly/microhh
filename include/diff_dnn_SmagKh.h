...
#ifndef DIFF_DNN_SMAGKH_H
#define DIFF_DNN_SMAGKH_H
...
class Diff_dnn_SmagKh : public Diff<TF>
{
    public:
        Diff_dnn_SmagKh(Master&, Grid<TF>&, Fields<TF>&, Boundary<TF>&, Input&);
        ~Diff_dnn_SmagKh();
    ...
    private:
        ...
        const Diffusion_type swdiff = Diffusion_type::Diff_dnn_SmagKh;
