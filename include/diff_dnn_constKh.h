...
#ifndef DIFF_DNN_CONSTKH_H
#define DIFF_DNN_CONSTKH_H
...
class Diff_dnn_constKh : public Diff<TF>
{
    public:
        Diff_dnn_constKh(Master&, Grid<TF>&, Fields<TF>&, Boundary<TF>&, Input&);
        ~Diff_dnn_constKh();
    ...
    private:
        ...
        const Diffusion_type swdiff = Diffusion_type::Diff_dnn_constKh;
