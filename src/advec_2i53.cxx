...
Advec_2i53<TF>::Advec_2i53(Master& masterin, Grid<TF>& gridin, Fields<TF>& fieldsin, Input& inputin) :
...
namespace
{
            ...
            const int jj, const int kk)
    {
        ...
        // Vertical terms interior with full 4/5th order vertical
...
template<typename TF>
void Advec_2i53<TF>::create(Stats<TF>& stats)
{
        ...
        const std::vector<TF>& w_mean)
{
    ...
    else if (fld.loc == gd.sloc)
    {
        ...
        throw std::runtime_error("Advec_2i53 cannot deliver flux field at that location");
}
