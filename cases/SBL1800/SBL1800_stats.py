...
st = thermo.variables['b'][start:end, :]
...
s2t = thermo.variables['b_2'][start:end, :]
sturbt = thermo.variables['b_w'][start:end, :]
sdifft = thermo.variables['b_diff'][start:end, :]
sfluxt = thermo.variables['b_flux'][start:end, :]
sgradt = thermo.variables['b_grad'][start:end, :]
...
plt.xlabel(r'$\overline{wb} [K m s^{-1}]$')
plt.ylabel(r'$z [m]$')
...
plt.ylim(0., 1500.)
plt.xlabel(r'$\overline{w b} [K m s^{-1}]$')
plt.ylabel(r'$z [m]$')
